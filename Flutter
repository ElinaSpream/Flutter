...
Widget productBanners() {
  return ListView(
    ...
    children: [
      product('chair3d', Color(0xffD86BFF), "Origami\nChair"),
      product('chair3d2', Color(0xff9A6BFF), "Adirondak\nChair"),
      product('chair3d2', Color(0xff5A3C99), "Origami\nChair"),
      product('chair3d', Color(0xff2232BE), "Adirondak\nChair"),
    ],
  );
}
